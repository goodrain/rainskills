...
"""Run the bootstrap validation fixtures end to end."""
...
from validate_bootstrap_output import validate_response_file


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run all bootstrap eval response fixtures through the deterministic validator."
    )
    parser.add_argument(
        "--eval-dir",
        type=Path,
    ...
    print(f"\nAll {len(response_paths)} bootstrap fixture set(s) passed.")
    return 0
