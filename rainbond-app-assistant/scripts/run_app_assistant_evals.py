...
"""Run all app-assistant deterministic eval fixtures."""
...
from validate_app_assistant_output import validate_response_file  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run all app-assistant response fixtures through the deterministic validator."
    )
    parser.add_argument(
        "--eval-dir",
        type=Path,
    ...
    print(f"\nAll {len(response_paths)} app-assistant fixture set(s) passed.")
    return 0
